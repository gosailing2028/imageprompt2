...
export const env = createEnv({
  ...
  runtimeEnv: {
    NEXTAUTH_URL: process.env.NEXTAUTH_URL || "https://image-prompt-auth-proxy.vercel.app",
    NEXTAUTH_SECRET: process.env.NEXTAUTH_SECRET || "default-secret-for-build",
    GOOGLE_CLIENT_ID: process.env.GOOGLE_CLIENT_ID,
    GOOGLE_CLIENT_SECRET: process.env.GOOGLE_CLIENT_SECRET,
    STRIPE_API_KEY: process.env.STRIPE_API_KEY,
    STRIPE_WEBHOOK_SECRET: process.env.STRIPE_WEBHOOK_SECRET,
    NEXT_PUBLIC_APP_URL: process.env.NEXT_PUBLIC_APP_URL || "https://image-prompt-auth-proxy.vercel.app",
